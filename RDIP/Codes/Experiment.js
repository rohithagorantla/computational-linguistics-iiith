function disp() {
    ...
    if (document.getElementById("lan").value == "English")                                               // to select any particular languague
    {
        ...
        var x = Math.floor(Math.random() * 9);                                                           // random number to select random sentences from given corpus
        ...
        var x = Math.floor(Math.random() * 6);                                                           // random number to select random sentences from given corpus
...
function newsen(k) {
    ...
    document.getElementById("s1").value += g;
